...
module.exports = class Home {
  ...
  save() {
  //  return db.execute(`INSERT INTO homes (houseName,price,location,rating,photoUrl,description) VALUES ('${this.houseName}',${this.price},
  //  ' ${this.location}',${this.rating},'${this.photoUrl}','${this.description}')`)
